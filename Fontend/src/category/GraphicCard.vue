<template>
    <div>
      <div>
        <img src="../assets/vga.png" alt="" class="w-100 rounded">
      </div>
      <div class="mt-3">
        <h4>การ์ดจอ (VGA) ของแท้ Graphic Card การ์ดจอคอม ราคาสุดพิเศษ</h4>
        <p>
            TECHWORLD จำหน่ายสินค้า การ์ดจอคอม (Graphic Card หรือ Video Card) หลากหลายรุ่น ทั้ง การ์ดจอ AMD, การ์ดจอ intel และ การ์ดจอ NVIDIA ครอบคลุมทุกความต้องการ โดยการ์ดจอคอมเป็นอุปกรณ์คอมพิวเตอร์ที่สำคัญอย่างหนึ่งสำหรับการใช้งานด้านกราฟิก ไม่ว่าจะเป็นการเล่นเกม การดูภาพยนตร์ หรือการทำงานด้านการออกแบบและตัดต่อภาพและวิดีโอ ราคาการ์ดจอใน TECHWORLD ขึ้นอยู่กับรุ่นและยี่ห้อ เริ่มต้นตั้งแต่ประมาณ 2,000 บาท ไปจนถึงมากกว่า 100,000 บาท สามารถเลือกซื้อได้ตามความต้องการที่ TECHWORLD  นอกจากนี้เรายังมีบริการหลังการขายที่ครบครัน ไม่ว่าจะเป็นการรับประกันสินค้า การบริการซ่อมแซม และบริการให้คำปรึกษาด้านเทคนิคที่จะคอยช่วยเหลือคุณตลอดเวลา เรื่องคอมไว้ใจเรา
      ...
      <div class="mt-5">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">GraphicCard</li>
          </ol>
        </nav>
      </div>
      <div class="d-flex">
        <div class="" role="group" style="max-width: 200px; min-width: 200px; margin-top: 32px; margin-right: 15px;">
          ...
          <label class="btn btn-light w-100 mb-3" for="option2">INNO3D</label>
          <input type="radio" class="btn-check" name="options" id="option3" autocomplete="off" />
          <label class="btn btn-light w-100 mb-3" for="option3">GALAX</label>
          <input type="radio" class="btn-check" name="options" id="option3" autocomplete="off" />
